...
public interface City {
   ...
   *
   * @param xCoordinate the X coordinate you want to get
   * @param yCoordinate the Y coordinate you want to get
   ...
   *
   * @param cityNode the {@link CityNode} that has the building you want
